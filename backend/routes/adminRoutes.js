...
const { getUsers, getUserDetails, removeUser, getDashboardStats, getPurchaseHistory } = require('../controllers/adminController');
...
router.get('/purchase-history', authenticate, authorizeAdmin, getPurchaseHistory);
